...
namespace _Project.NetworkManagement.DenariaServer.Scripts.Services
{
    public class DenariaServerService : IDenariaServerService
    {
        ...
        [Inject] public DenariaServerReceiveSpawnSignal ReceiveSpawnSignal { get; set; }
        [Inject] public DenariaServerReceivePositionUpdateSignal ReceivePositionUpdateSignal { get; set; }
        [Inject] public DenariaServerReceiveRotationUpdateSignal ReceiveRotationUpdateSignal { get; set; }
        [Inject] public DenariaServerReceiveDisconnectSignal ReceiveDisconnectSignal { get; set; }
                ...
                for (ushort i = 0; i < messagesLength; i++)
                {
                    ...
                    switch (messageType)
                    {
                        ...
                        case 2: // Location Update
                            ...
                            break;
                        default:
                            Debug.LogError($"WARNING! Unknown message type: {messageType}");
                            break;
                    }
                }
            }
        ...
        {
            byte messageType = (byte)DenariaServerSendOpCode.Connect;
