using System;
using System.Linq;
using _Project.Shooting.Scripts.Enums;
...
namespace _Project.Shooting.Scripts.ScriptableObjects
{
    ...
    public class ShootConfigurationScriptableObject : ScriptableObject
    {
        ...
        public ShootingType ShootingType = ShootingType.FromCamera;
        ...
        {
            return Vector3.zero; //TODO: Enable
        ...
        public object Clone()
        {
            ...
            ObjectExtensions.CopyValues(this, config);
