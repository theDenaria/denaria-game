...
using UnityAnalyticsEventParameter = _Project.Analytics.Models.UnityAnalyticsEventParameter;

namespace _Project.Analytics.Services
{
    public class UnityAnalyticsService : BaseAnalyticsService<UnityAnalyticsEvent,UnityAnalyticsEventParameter>
    {
