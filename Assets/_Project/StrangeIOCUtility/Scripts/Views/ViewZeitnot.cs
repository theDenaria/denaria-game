...
namespace _Project.StrangeIOCUtility.Scripts.Views
{
	//See: https://odininspector.com/tutorials/serialize-anything/implementing-the-odin-serializer
	[ShowOdinSerializedPropertiesInInspector]
	public class ViewZeitnot : MonoBehaviour, IView, ISerializationCallbackReceiver, ISupportsPrefabSerialization
    {
	    #region StrangeIOC
